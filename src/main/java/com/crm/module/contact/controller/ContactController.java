...
public class ContactController {
    ...
    @PostMapping()
    ResponseEntity<Response> createContact(@Valid @RequestBody CreateContactRequest request){
    ...
    @GetMapping("/{id}")
    ResponseEntity<Response> getContact(@PathVariable UUID id){
    ...
    @GetMapping()
    ResponseEntity<Response> getContacts(@RequestParam(defaultValue = "0") int page){
    ...
    @PutMapping("/{id}")
    ResponseEntity<Response> updateContact(@Valid @RequestBody UpdateContactRequest request, @PathVariable UUID id){
    ...
    @DeleteMapping("/{id}")
    ResponseEntity<Response> deleteContact(@PathVariable UUID id){
